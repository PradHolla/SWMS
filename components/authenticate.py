...
# -----------------------------
login_link = f"{COGNITO_DOMAIN}/login?client_id={CLIENT_ID}&response_type=token&scope=email+openid&redirect_uri={APP_URI}"
...
html_button_login = f"{html_css_login}<a href='{login_link}' class='button-login' target='_self'>Log In</a>"
